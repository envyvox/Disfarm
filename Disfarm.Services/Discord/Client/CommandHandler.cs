    ...
    public class CommandHandler
    {
        ...
        private async Task HandleExceptions(IDiscordInteraction interaction, ExecuteResult result)
        {
            ...
            var embed = new EmbedBuilder()
                ...
                .WithAuthor(Response.SomethingWentWrongTitle.Parse(user.Language), interaction.User.GetAvatarUrl());
        ...
        private async Task HandleError(IDiscordInteraction interaction, IResult result)
        {
            ...
            var embed = new EmbedBuilder()
                ...
                .WithAuthor(Response.SomethingWentWrongTitle.Parse(user.Language), interaction.User.GetAvatarUrl())
                .WithDescription(
                    $"{interaction.User.Mention.AsGameMention(user.Title, user.Language)}, {result.ErrorReason}");
