...
namespace Disfarm.Services.Discord.Emote.Extensions
{
    public static class EmoteExtensions
    {
        ...
        public static string DisplayProgressBar(this Dictionary<string, EmoteDto> emotes, uint percent)
        {
            ...
            return bars[bars.Keys.Where(x => x <= percent).Max()];
        }
    }
}