...
namespace Disfarm.Services.Extensions
{
	public static class StringExtensions
	{
		...
		public static string AsGameMention(this string mention, Title title, Language language)
		{
			var emotes = DiscordRepository.Emotes;

			return $"{emotes.GetEmote(title.EmoteName())} {title.Localize(language)} {mention}";
		}
