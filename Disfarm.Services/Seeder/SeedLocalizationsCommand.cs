                ...
                .Cast<LocalizationCategory>())
            {
                switch (category)
                {
                    ...
                    case LocalizationCategory.Container:
                        ...
                        commands.Add(new CreateLocalizationCommand(
                            category, Container.Token.ToString(), Language.English, "container with tokens", "containers with tokens", "containers with tokens"));
                        commands.Add(new CreateLocalizationCommand(
                            category, Container.Supply.ToString(), Language.English, "container with supplies", "containers with supplies", "containers with supplies"));
                        commands.Add(new CreateLocalizationCommand(
                            category, Container.Token.ToString(), Language.Russian, "контейнер с токенами", "контейнера с токенами", "контейнеров с токенами"));
                        commands.Add(new CreateLocalizationCommand(
                            category, Container.Supply.ToString(), Language.Russian, "контейнер с припасами", "контейнера с припасами", "контейнеров с припасами"));
